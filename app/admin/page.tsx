              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <div className="bg-[#0A0A0B] border border-white/5 rounded-lg p-3 space-y-2 text-sm h-full">
                    ...
                    <p><span className="text-slate-500 w-28 inline-block">Copilot Prompts:</span> <span className={editingUser.copilotPromptsLeft > 0 ? "text-purple-400 font-bold" : "text-red-400 font-bold"}>{editingUser.copilotPromptsLeft ?? 20} Left</span></p>

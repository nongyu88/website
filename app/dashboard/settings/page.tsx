...
import { ArrowLeft, User, CreditCard, Building, Shield, Bell, FileText } from "lucide-react"
...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0A0A0B] text-slate-900 dark:text-slate-300 font-sans transition-colors duration-300 pb-20">
      ...
      <header className="border-b border-slate-200 dark:border-white/10 bg-white dark:bg-[#0A0A0B] sticky top-0 z-10 px-6 py-4 flex items-center justify-between">
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/dashboard/settings/profile" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
                <User className="w-6 h-6 text-purple-500 dark:text-purple-400 shrink-0" />
                <div>
            ...
            <Link href="/dashboard/settings/communications" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
                <Bell className="w-6 h-6 text-purple-500 dark:text-purple-400 shrink-0" />
                <div>
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Link href="/dashboard/settings/business" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
                <Building className="w-6 h-6 text-purple-500 dark:text-purple-400 shrink-0" />
                <div>
            ...
            <Link href="/dashboard/settings/security" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
                <Shield className="w-6 h-6 text-purple-500 dark:text-purple-400 shrink-0" />
                <div>
            ...
            <Link href="/dashboard/settings/plans" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
            ...
            <Link href="/dashboard/settings/compliance" className="p-6 rounded-xl border border-slate-200 dark:border-white/10 bg-white dark:bg-[#111113] hover:bg-slate-100 dark:hover:bg-[#1A1A1D] transition-colors group cursor-pointer block shadow-sm dark:shadow-none">
              <div className="flex space-x-4">
